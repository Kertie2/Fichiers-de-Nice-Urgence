...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 16 avr. 2025 à 00:54
...
INSERT INTO `agents` (`id`, `nom`, `prenom`, `email`, `service`, `telephone`, `avertissement`, `password`, `niveau_accreditation`, `date_inscription`, `ip`) VALUES
(1, 'Admin', 'Admin', 'admin@example.com', 'STAFF', NULL, NULL, '$2b$10$fwkub4AIUKcMEdjcWXuYEeRDI.4WW5YhKNjV45KCiYB65QXr1ug16\r\n', 4, '2025-04-15 22:53:47', NULL);
